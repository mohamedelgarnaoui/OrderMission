...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			<!-- Logo -->
			<a href="starter.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									...
									<p>
										Mohamed Elgarnaoui - Java Professor <small>Membre
											depuis 06/2020</small>
									</p></li>
								<!-- Menu Body -->
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					<ul class="sidebar-menu">
						...
						<li class="active treeview"><a href="starter.html"> <i
						...
						<li><a href="#"> <i class="fa fa-th"></i> <span>
							...
							<ul class="treeview-menu">
								<li><a href="data.html"><i class="fa fa-circle-o"></i>
										Tous les Professeurs</a></li>
								<li><a href="ajout_produit.html"><i
										class="fa fa-circle-o"></i> Ajouter professeur</a></li>
								<li><a href="#"><i class="fa fa-circle-o"></i> Modifier
										professeur</a></li>
							</ul></li>
						<li><a href="#"> <i class="fa fa-th"></i> <span>
							...
							<ul class="treeview-menu">
								<li><a href="data2.html"><i class="fa fa-circle-o"></i>
