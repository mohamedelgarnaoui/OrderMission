            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <select class="form-control select2" style="width: 100%;">
                  <option selected="selected">selectionner votre destination</option>
			  ...
			  <div class="form-group">
                ...
                <select class="form-control select2" multiple="multiple" data-placeholder="choisissez vos moyens de transport" style="width: 100%;">
                  <option>Voiture personnel</option>
                  <option>Voiture de location</option>
                  <option>Train</option>
                  <option>Bus</option>
				  <option>Avion</option>
                </select>
